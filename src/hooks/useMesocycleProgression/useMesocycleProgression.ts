...
const initExerciseProgression = (muscle: string, total_frequency: number, exerciseSession: number, total_microcycles: number, total_mesocycles: number, deload: boolean) => {
